...
<body>
	...
	<div class="text-center">
		<h2 class="text-color">Shift your focus from sickness to well-being.</h2>
	</div>
    ...
    <div class="card-body">
      ...
      <p class="card-text">Behind every successful project is an admin who logged in, stayed focused, and made it happen.</p>
    </div>
  </div>
    </div>
    <div class="col-sm-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">With each login, a doctor enters a world of responsibility, compassion, and healing.</p>
    </div>
  </div>
    </div>
    <div class="col-sm-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Your health,our priority: Pharmacists, the heartbeat of healthcare.</p>
    </div>
  </div>
    </div>
    <div class="col-sm-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">In the digital age, the receptionist is the human touch that technology can't replace.</p>
    </div>
  </div>
    </div>
</div>  
