    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
              Welcome to our Hospital Management System, where innovation meets healthcare efficiency. With a commitment to transforming the way medical institutions operate, we have developed a comprehensive and user-friendly platform tailored for seamless hospital management. Our system is designed to streamline administrative tasks, enhance communication between healthcare professionals, and optimize patient care. By leveraging cutting-edge technology, we empower healthcare providers to deliver exceptional services while ensuring a smooth and organized workflow. At the heart of our mission is a dedication to supporting medical professionals and administrators in their pursuit of providing top-notch healthcare services. Join us in revolutionizing the healthcare industry with our Hospital Management System  where excellence meets technology for the well-being of all.
          </b>
        </p>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 6299340678 / +91 9939563537<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">sanjaykumarqwas@gmail.com
            </b>
        </p>
        </div>
      </div>
